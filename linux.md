...
The `tests/integration/assets` directory contains the following baseband recordings:

| File                        | Use                                     |
|-----------------------------|-----------------------------------------|
| `M17_test_baseband_24k.raw` | Runtime demodulation; src callsign only |
...
cp tests/integration/assets/M17_test_baseband_24k.raw /tmp/baseband.raw
# Build
