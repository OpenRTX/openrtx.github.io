...
| ------- | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| address | uint8_t[8] | M17 address stored in 48 bits, following their [address encoding](https://m17-protocol-specification.readthedocs.io/en/latest/address_encoding.html) |
