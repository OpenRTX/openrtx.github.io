...
---   | ---    |   ---                |  ---
 ...
 PB4  |        |                      |
 PB5  |        |                      |
 PB6  | output | speaker mute         | active low
 PB7  |        |                      |
 PB8  |        |                      |
 PB9  |        |                      |
 PB10 | input  | channel sel. encoder |
 PB11 | input  | channel sel. encoder |
...
---   | ---    |   ---                          |  ---
 PD0  | input  | keypad ?                       |
 PD1  | input  | keypad ?                       |
 PD2  | input  |     "P1" button                | active low
 PD3  | input  | red "emergency" button         | active low
 PD4  | input  |     power button               | active low
 PD5  |        |                                |
 PD6  |        |                                |
 PD7  |        |                                |
 ...
 PD15 | output | mic. and audio amp. pwr enable |
